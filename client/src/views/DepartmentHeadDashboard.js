...
const data = {
  labels: ["CSE101", "CSE201", "CSE203", "CSE212", "CSE216", "CSE303", "CSE317", "CSE405"],
  datasets: [
    {
      label: "# of Votes",
      data: [70, 81, 72, 65, 69, 55, 71, 75],
      backgroundColor: [
        "rgba(255, 99, 132, 0.2)",
        "rgba(54, 162, 235, 0.2)",
        "rgba(255, 206, 86, 0.2)",
                ...
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      ...
                      <Card.Title as="h4">21</Card.Title>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
                ...
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      ...
                      <Card.Title as="h4">68%</Card.Title>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
